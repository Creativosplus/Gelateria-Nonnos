    ...
    class Dventa
    {
        ...
        public string DisminuirStock(int iddetalle_ingreso, int cantidad)
        {
            ...
            try
            {
                ...
                resp = SqlCmd.ExecuteNonQuery() == 1 ? "OK" : "NO se Actualizó el stock";
                ...
                if (resp.Equals("OK"))
                {
                    ...
                    foreach (Ddetalle_venta det in Detalle)
                    {
                        ...
                        else
                        {
                            ...
                            resp = DisminuirStock(det.Iddetalle_ingreso, det.Cantidad);
                            if (!resp.Equals("OK"))
                            {
                                break;
                            }
